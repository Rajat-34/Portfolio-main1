...
![preview](https://raw.githubusercontent.com/rajatshukla/rajatshukla.dev/main/thumbnail.png)
...
```bash
$ git clone https://github.com/rajatshukla/portfolio.git
$ cd rajatshukla.dev
$ npm install
$ npm run dev
```
...
Licensed under the [MIT license](https://github.com/rajatshukla/portfolio/blob/main/LICENSE).
